...
class LocationsHome extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    var mapController = useState(mapOptions.controller ?? MapController());
...
/// A map that can display locations.
class LocationsMapSimple extends HookWidget {
  /// [LocationsMapSimple] constructor
  const LocationsMapSimple({
    super.key,
  });
